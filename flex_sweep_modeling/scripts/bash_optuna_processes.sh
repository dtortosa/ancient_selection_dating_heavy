...
python3.9 /opt/scripts/flex_sweep_continuous_modeling_yoruba.py --optuna_seed=2508 --n_trials=20000 &
#--optuna_seed=
#--optuna_seed=8765
#--optuna_seed=0432
sleep 30s
...
python3.9 /opt/scripts/flex_sweep_continuous_modeling_yoruba.py --optuna_seed=8364 --n_trials=20000 &
#--optuna_seed=0327
#--optuna_seed=4572
#--optuna_seed=9456
python3.9 /opt/scripts/flex_sweep_continuous_modeling_yoruba.py --optuna_seed=2094 --n_trials=20000 &
#--optuna_seed=8869
#--optuna_seed=5234
#--optuna_seed=0467
python3.9 /opt/scripts/flex_sweep_continuous_modeling_yoruba.py --optuna_seed=5813 --n_trials=20000 &
#--optuna_seed=5391
#--optuna_seed=0976
#--optuna_seed=1624
python3.9 /opt/scripts/flex_sweep_continuous_modeling_yoruba.py --optuna_seed=0636 --n_trials=20000
#--optuna_seed=0139
#--optuna_seed=3413
#--optuna_seed=8563
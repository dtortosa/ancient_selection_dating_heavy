...
python3.9 /opt/scripts/flex_sweep_continuous_modeling_yoruba.py --optuna_seed=3432 --n_trials=20000 &
sleep 30s 
...
python3.9 /opt/scripts/flex_sweep_continuous_modeling_yoruba.py --optuna_seed=6754 --n_trials=20000 &
python3.9 /opt/scripts/flex_sweep_continuous_modeling_yoruba.py --optuna_seed=1353 --n_trials=20000 &
python3.9 /opt/scripts/flex_sweep_continuous_modeling_yoruba.py --optuna_seed=5464 --n_trials=20000 &
python3.9 /opt/scripts/flex_sweep_continuous_modeling_yoruba.py --optuna_seed=8796 --n_trials=20000
...
list_factors_across_windows_paths = list.files(paste(path_outside_data, "/predictors_gene_windows_v2/factors_across_windows", sep=""), pattern=".txt", full.names=TRUE)
...
#get the path of all partitions
list_factors_gene_center_paths = list.files(paste(path_outside_data, "/predictors_gene_windows_v2/factors_gene_center", sep=""), pattern=".txt", full.names=TRUE)
...
#save
write.table(factors_table_final, paste(path_outside_pipeline, "/factors_table.txt", sep=""), row.names=FALSE, col.names=FALSE, sep=" ", quote=FALSE)
